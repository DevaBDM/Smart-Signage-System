...
your config.py alongside it. The shared code in the Device/ package will
pick up your per-device configuration automatically.
"""
import sys
import os

# Add the shared Device package to the path.
